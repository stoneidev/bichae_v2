    ...
    <footer style={{ background: 'var(--brand-obsidian)', color: '#FFF', padding: '56px 0 28px 0', borderTop: '1px solid var(--border-subtle)' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '36px', marginBottom: '36px' }}>
          ...
          <div>
            <h4 style={{ fontSize: '0.825rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#E5E7EB', marginBottom: '14px' }}>Tracked Global Platforms</h4>
          ...
          <div>
            <h4 style={{ fontSize: '0.825rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#E5E7EB', marginBottom: '14px' }}>Editorial Disclosure</h4>
        ...
        <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.1)', paddingTop: '22px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', fontSize: '0.8rem', color: '#9CA3AF' }}>
          <div>© 2026 BICHAE. Independent K-Beauty editorial dossier.</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            Curated with <Heart size={14} color="var(--brand-rose)" fill="var(--brand-rose)" /> for Global K-Beauty &amp; Science Enthusiasts
          </div>
        </div>
